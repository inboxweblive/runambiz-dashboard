        ...
        <div className="admin-field-row">
          ...
          <div className="admin-field">
            ...
            <input
              type="text"
              value={ctaUrl}
              placeholder="https://runambiz.com/dashboard.html"
              onChange={
...
function OutreachPanel({ store, onClose, onChanged }) {
  ...
  const storeUrl =
    `https://${store.slug}.runambiz.com`;


  const claimUrl =
    store.claim_token
      ? `https://runambiz.com/claim.html?token=${store.claim_token}`
      : null;
    ...
    >
      ...
      {!store.claimed_at && (
        ...
        <div className="admin-drawer-actions">
          ...
          <a
            className="admin-primary-button"
            href={`/dashboard.html?store=${store.id}`}
            target="_blank"
            rel="noreferrer"
          >
            <Rocket size={15} />
